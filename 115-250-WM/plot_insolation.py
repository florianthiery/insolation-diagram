...
# INPUT
# -------------------------------------------------
data_file = "orbital_param_wm.tab"  # von prepare_data_wm.py erzeugt
COL_INSOL_SITE = "EXI_WM"  # Insolation am Standort statt 65°N
...
col_insol = COL_INSOL_SITE  # Insolation am Standort [W/m²]
...
ax.set_xlabel(INSOL_LABEL, fontsize=24, labelpad=12, fontweight="bold")
